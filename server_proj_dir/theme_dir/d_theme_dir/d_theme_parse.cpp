...
void DThemeClass::processSetupRoom (char *data_val)
{
    ...
    if (!room) {
        ...
        downlink_data = data_ptr = (char *) phwangMalloc(FT_Command_Class::FT_DATA_BUFFER_SIZE + 4, MallocClass::DTHEME_SETUP_ROOM1);
...
void DThemeClass::processPutRoomData (char *data_val)
{
    ...
    if (!room) {
        ...
        downlink_data = data_ptr = (char *) phwangMalloc(FT_Command_Class::FT_DATA_BUFFER_SIZE + 4, MallocClass::DTHEME_PUT_ROOM_DATA1);
