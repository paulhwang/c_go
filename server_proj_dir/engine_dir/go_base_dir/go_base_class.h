...
public:
    ...
    void setRoomIdIndex(char const *room_id_index_val) {memcpy(this->theRoomIdIndex, room_id_index_val, SIZE_DEF::ROOM_II_SIZE); this->theRoomIdIndex[SIZE_DEF::ROOM_II_SIZE] = 0;}
