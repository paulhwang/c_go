...
public:
    ...
    int const static FE_DL_HEADER_SIZE = FE_DEF::FE_COMMAND_SIZE + SIZE_DEF::AJAX_ID_SIZE;
    int const static FE_DL_BUFFER_SIZE = FE_DL_HEADER_SIZE + RESULT_DEF::RESULT_SIZE + 1;
