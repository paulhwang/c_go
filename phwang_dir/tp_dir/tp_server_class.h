...
public:
    ...
    TpTransferClass *startServer(unsigned short port_val, void (*accept_callback_func_val)(void *, void *), void (*receive_callback_val)(void *, void *), void *receive_callback_parameter_val, StartServerOutputStruct *output_val);
