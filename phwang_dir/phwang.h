...
/* queue */
void *phwangMallocSuspendedQueue(int debug_on_val, int size_val, char const *who_val);
void *phwangMallocQueue(int debug_on_val, int size_val, char const *who_val);
