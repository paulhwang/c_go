...
PHWANG_OBJS = $(PHWANG_DIR)/phwang.o $(PHWANG_DIR)/phwang_class.o $(JSON_OBJS) $(SUSPEND_OBJS) $(LIST_MGR_OBJS) $(ID_INDEX_LIST_OBJS) $(QUEUE_OBJS) $(NET_OBJS) 

SERVER_OBJS = $(SERVER_DIR)/go_server.o $(SERVER_DIR)/main_class.o
LINK_MGR_OBJS = $(LINK_MGR_DIR)/link_class.o $(LINK_MGR_DIR)/session_class.o 
GROUP_MGR_OBJS = $(GROUP_MGR_DIR)/group_class.o 
...
ROOM_MGR_OBJS = $(ROOM_MGR_DIR)/room_class.o 
...
THEME_OBJS = $(U_THEME_OBJS)  $(D_THEME_OBJS) $(ROOM_MGR_OBJS) $(THEME_DIR)/theme_class.o 
...
BASE_MGR_OBJS = $(BASE_MGR_DIR)/base_mgr_class.o 
ENGINE_OBJS = $(D_ENGINE_OBJS) $(BASE_MGR_OBJS) $(GO_BASE_OBJS) $(ENGINE_DIR)/engine_class.o 
