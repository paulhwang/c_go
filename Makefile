...
BASE_MGR_OBJS = $(BASE_MGR_DIR)/base_mgr_class.o $(BASE_MGR_DIR)/base_mgr_parse.o $(BASE_MGR_DIR)/base_mgr_transmit.o $(BASE_MGR_DIR)/base_mgr_base.o $(GO_BASE_OBJS)
ENGINE_OBJS = $(D_ENGINE_OBJS) $(BASE_MGR_OBJS) $(ENGINE_DIR)/engine_class.o 
