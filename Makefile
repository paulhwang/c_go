...
TRANSPORT_OBJS = $(TRANSPORT_DIR)/transport_class.o $(TRANSPORT_DIR)/transport_thread.o $(TRANSPORT_DIR)/transport_exports.o $(TRANSPORT_DIR)/transport_server_class.o 
