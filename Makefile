...
TP_OBJS = $(TP_DIR)/tp_transfer_class.o $(TP_DIR)/tp_transfer_class_transmit.o $(TP_DIR)/tp_transfer_class_receive.o $(TP_DIR)/tp_transfer_class_receive2.o
NET_OBJS = $(TCP_OBJS) $(TP_OBJS) $(NET_DIR)/net_root_class.o
