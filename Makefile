...
TP_OBJS = $(TP_DIR)/tp_class.o $(TP_DIR)/tp_thread.o $(TP_DIR)/tp_exports.o $(TP_DIR)/tp_server_class.o $(TP_DIR)/tp_transfer_class.o $(TP_DIR)/tp_transfer_thread.o 
QUEUE_OBJS = $(UTILS_DIR)/queue_entry_class.o $(UTILS_DIR)/queue_mgr_class.o
UTILS_OBJS = $(TP_OBJS) $(QUEUE_OBJS) $(UTILS_DIR)/logit.o $(UTILS_DIR)/suspend_class.o 
