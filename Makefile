...
U_FABRIC_OBJS = $(GROUP_MGR_OBJS) $(U_FABRIC_DIR)/u_fabric_class.o $(U_FABRIC_DIR)/u_fabric_transmit.o $(U_FABRIC_DIR)/u_fabric_export.o 
...
GAME_D_SERVER_OBJS = $(ROOM_MGR_OBJS) $(GAME_D_SERVER_DIR)/game_d_server_class.o $(GAME_D_SERVER_DIR)/game_d_server_transmit.o $(GAME_D_SERVER_DIR)/game_d_server_export.o 
