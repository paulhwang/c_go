...
TCP_OBJS = $(TCP_DIR)/tcp_connect_class.o
NET_OBJS = $(TCP_OBJS) $(NET_DIR)/net_root_class.o $(NET_DIR)/tp_server_class.o $(NET_DIR)/tp_transfer_class.o $(NET_DIR)/tp_transfer_class_transmit.o $(NET_DIR)/tp_transfer_class_receive.o
SQL_OBJS = $(SQL_DIR)/sql_class.o
MALLOC_OBJS = $(MALLOC_DIR)/malloc_class.o
ENCODE_OBJS = $(ENCODE_DIR)/encode_class.o
ABEND_OBJS = $(ABEND_DIR)/abend_class.o
THREAD_OBJS = $(THREAD_DIR)/thread_root_class.o 
OBJECT_OBJS = $(OBJECT_DIR)/object_class.o
PHWANG_OBJS = $(PHWANG_DIR)/phwang.o $(PHWANG_DIR)/phwang_class.o $(JSON_OBJS) $(SUSPEND_OBJS) $(LIST_MGR_OBJS) $(ARRAY_MGR_OBJS) $(ID_INDEX_LIST_OBJS) $(QUEUE_OBJS) $(NET_OBJS) $(SQL_OBJS) $(MALLOC_OBJS) $(ENCODE_OBJS) $(ABEND_OBJS) $(THREAD_OBJS) $(OBJECT_OBJS)
