...
NET_OBJS = $(NET_DIR)/net_root_class.o $(NET_DIR)/tp_server_class.o $(NET_DIR)/tcp_connect_class.o $(NET_DIR)/tp_transfer_class.o $(NET_DIR)/tp_transfer_class_transmit.o $(NET_DIR)/tp_transfer_class_receive.o $(NET_DIR)/tp_connect.o 
