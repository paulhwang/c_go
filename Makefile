...
GAME_U_SERVER_OBJS = $(GAME_U_SERVER_DIR)/game_u_server_class.o $(GAME_U_SERVER_DIR)/game_u_server_receive.o $(GAME_U_SERVER_DIR)/game_u_server_export.o $(GAME_U_SERVER_DIR)/game_u_server_test.o 
GAME_D_SERVER_OBJS = $(GAME_D_SERVER_DIR)/game_d_server_class.o $(GAME_D_SERVER_DIR)/game_d_server_receive.o $(GAME_D_SERVER_DIR)/game_d_server_export.o 
