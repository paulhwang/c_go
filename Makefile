...
ROOT_DIR = root_dir
UTILS_DIR = utils_dir
TRANSPORT_DIR = $(ROOT_DIR)/transport_dir
...
TRANSPORT_OBJS = $(TRANSPORT_DIR)/transport_class.o $(TRANSPORT_DIR)/transport_thread.o $(TRANSPORT_DIR)/transport_exports.o $(TRANSPORT_DIR)/transport_server_class.o $(TRANSPORT_DIR)/tp_transfer_class.o 
QUEUE_OBJS = $(UTILS_DIR)/queue_entry_class.o $(UTILS_DIR)/queue_mgr_class.o
UTILS_OBJS = $(TRANSPORT_OBJS) $(QUEUE_OBJS) $(UTILS_DIR)/logit.o $(UTILS_DIR)/suspend_class.o 
