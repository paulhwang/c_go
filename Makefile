...
LINK_MGR_DIR = $(D_FABRIC_DIR)/link_mgr_dir
...
EXTERN_OBJS = $(EXTERN_DIR)/phwang_suspend.o $(EXTERN_DIR)/phwang_queue.o $(EXTERN_DIR)/phwang_tp.o $(EXTERN_DIR)/phwang_base.o 
PHWANG_OBJS = $(EXTERN_DIR)/phwang.o $(EXTERN_DIR)/phwang_class.o $(JSON_OBJS) $(SUSPEND_OBJS) $(QUEUE_OBJS) $(NET_OBJS) $(EXTERN_OBJS) 
...
GAME_U_SERVER_OBJS = $(GAME_U_SERVER_DIR)/game_u_server_class.o $(GAME_U_SERVER_DIR)/game_u_server_receive.o $(GAME_U_SERVER_DIR)/game_u_server_transmit.o $(GAME_U_SERVER_DIR)/game_u_server_export.o $(GAME_U_SERVER_DIR)/game_u_server_test.o 
GAME_D_SERVER_OBJS = $(GAME_D_SERVER_DIR)/game_d_server_class.o $(GAME_D_SERVER_DIR)/game_d_server_receive.o $(GAME_D_SERVER_DIR)/game_d_server_transmit.o $(GAME_D_SERVER_DIR)/game_d_server_export.o 
...
SERVER_PROJ_OBJS = $(SERVER_OBJS) $(LINK_MGR_OBJS) $(FABRIC_OBJS) $(GROUP_MGR_OBJS) $(GAME_SERVER_OBJS)
