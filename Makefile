...
TRANSPORT_OBJS = $(TRANSPORT_DIR)/tp_class.o $(TRANSPORT_DIR)/tp_thread.o $(TRANSPORT_DIR)/tp_exports.o $(TRANSPORT_DIR)/tp_server_class.o $(TRANSPORT_DIR)/tp_transfer_class.o 
